...
/**
 * This servlet class is responsible for retrieving all rules based on particular resource
 */
@WebServlet("/getByResource")
public class GetByResource extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/resourceRules.jsp");
